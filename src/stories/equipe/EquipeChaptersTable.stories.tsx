...
const sampleRows: EquipeChapterListRow[] = [
  {
    ...
    authorIds: ["u1", "u2"],
    authors: [
      { userId: "u1", name: "Ana Silva", photoPath: null, active: true },
      { userId: "u2", name: "Bruno Costa", photoPath: null, active: true },
    ],
    ratingAvg: 4.3,
    ratingCount: 155,
  },
  {
    ...
    hyperlink: null,
    authorIds: ["u3"],
    authors: [{ userId: "u3", name: "Carla M.", photoPath: null, active: true }],
    ratingAvg: null,
    ratingCount: 0,
  },
  {
    ...
    authorIds: ["u4"],
    authors: [{ userId: "u4", name: "Diego", photoPath: null, active: false }],
    ratingAvg: 5,
    ratingCount: 1,
  },
]
