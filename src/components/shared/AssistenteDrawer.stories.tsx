    ...
    return (
      <div className="p-8">
        ...
        <AssistenteDrawer 
            ...
            integracoes={[
                { id: "1", provider: "Google", model: "gemini-1.5-pro", descricao: "Gemini Pro (Legacy)", active: true, createdAt: Date.now() },
                { id: "2", provider: "OpenAI", model: "gpt-4o", descricao: "GPT-4o Premium", active: true, createdAt: Date.now() }
            ]}
        />
      </div>
    )
