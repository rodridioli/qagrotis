...
import { SYSTEM_LIST } from "@/features/qa/lib/qagrotis-constants"
import { CenarioTipoBadge, ResultadoBadge } from "@/components/shared/StatusBadge"
...
import { criarSuite, atualizarSuite, removerHistoricoSuite, encerrarSuite, reabrirSuite, type SuiteRecord } from "@/features/qa/actions/suites"
import { buildSuiteCenarioRefByIdMap, refLabelForSuiteCenario } from "@/features/qa/lib/suite-cenario-ref"
import { nomeParaTituloExportJira } from "@/features/qa/lib/jira-export-nome-cenario"
import { downloadMarkdownFile, suiteMarkdownDownloadFilename } from "@/features/qa/lib/suite-markdown-export"
import { type EvFile, deleteEvidenceFile, evidenceFileToBlob } from "@/features/qa/lib/evidence-storage"
import { evHistoricoStorageKey, evScenarioStorageKey } from "@/features/qa/lib/evidence-session-keys"
import { applyJiraAttachmentUrlsToMarkdown } from "@/features/qa/lib/jira-evidence-markdown"
