...
export default function ClockworkConfigButton() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      setToken("")
      toast.success("Integração Clockwork salva com sucesso.")
      setOpen(false)
    } catch (e) {
  ...
  return (
    <>
      ...
      >
        ...
        <span className="font-semibold text-text-primary">Integração Clockwork</span>
      </button>

      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Integração Clockwork</DialogTitle>
          </DialogHeader>
